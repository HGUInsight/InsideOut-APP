...
class MyTextStyles {
  static const TextStyle miniTextStyle = TextStyle(
      fontSize: 15, fontWeight: FontWeight.bold, color: ColorStyle.mainColor1
  ...
  static const TextStyle titleTextStyle2 = TextStyle(
      fontSize: 20, fontWeight: FontWeight.bold, color: ColorStyle.mainColor1
      // Additional style options can be set here
      // Example: fontWeight: FontWeight.bold, color: Colors.black
      );
